...
(
    ...
    (
		...
		'pintips' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_wp_archive_game']['pintips'],
			'search'                  => true,
			'inputType'               => 'text',
		...
		'papa_vid' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_wp_archive_game']['papa_vid'],
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('rgxp'=>'url', 'decodeEntities'=>true, 'maxlength'=>255, 'tl_class'=>'w50'),
			'sql'                     => "varchar(255) NOT NULL default ''"
		...
		'papa_rules' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_wp_archive_game']['papa_rules'],
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('rgxp'=>'url', 'decodeEntities'=>true, 'maxlength'=>255, 'tl_class'=>'w50'),
			'sql'                     => "varchar(255) NOT NULL default ''"
		...
		'pin_vids' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_wp_archive_game']['pin_vids'],
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('rgxp'=>'url', 'decodeEntities'=>true, 'maxlength'=>255, 'tl_class'=>'w50'),
			'sql'                     => "varchar(255) NOT NULL default ''"
		...
		'em_guide' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_wp_archive_game']['em_guide'],
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('rgxp'=>'url', 'decodeEntities'=>true, 'maxlength'=>255, 'tl_class'=>'w50'),
			'sql'                     => "varchar(255) NOT NULL default ''"
		),	
		'pinball_spinner' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_wp_archive_game']['pinball_spinner'],
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('rgxp'=>'url', 'decodeEntities'=>true, 'maxlength'=>255, 'tl_class'=>'w50'),
			'sql'                     => "varchar(255) NOT NULL default ''"
